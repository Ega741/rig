    ...
    <>
      ...
      <footer className="footer">
        <div>
          ...
          <p>
            Mine ETH in the browser. 40% of the token's trading fees flow into the pool (60% to the team, fixed in the contract); every round
            splits the release by work. No mint, no reserve.
          </p>
        </div>
        <div>
